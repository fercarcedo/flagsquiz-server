...
db.none('CREATE TABLE IF NOT EXISTS logs(correct INTEGER NOT NULL, incorrect INTEGER NOT NULL, time INTEGER NOT NULL, score INTEGER NOT NULL, time_until_first_correct INTEGER NOT NULL, time_until_first_incorrect INTEGER NOT NULL, max_consecutive_correct INTEGER NOT NULL, max_consecutive_incorrect INTEGER NOT NULL)')
